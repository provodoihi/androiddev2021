...
public class WeatherAndForecastFragment extends Fragment {
    ...
    public static WeatherAndForecastFragment newInstance(Integer param1, String param2) {
...
//         Inflate the layout for this fragment
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentTransaction.add(R.id.fragment_parent,weatherFragment).add(R.id.fragment_parent,forecastFragment).commit();
    }
